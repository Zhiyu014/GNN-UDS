...
2. training
    ...
    ```
    python main.py --train --env (env_name) --data_dir (data_name) --model_dir (model_name) (--edge_fusion) (--act conti/rand) (--conv GAT) (--recurrent Conv1D) (--batch_size 64) (--epochs 20000) (--if_flood) (--resnet) (--seq_in 60) (--seq_out 60) (--n_sp_layer 5) (--n_tp_layer 5)
    ```
